...
const messages:IMessages = {
  "\n        Though filling out this form is preferrable, you can also email bugs@budgetwithbuckets.com\n      ": {
    val: "\n       Wypełnienie formularza jest preferowane, ale jeśli wolisz możesz wysłać wiadomość na adres bugs@budgetwithbuckets.com\n      ",
    translated: true,
    h: "05fPQ/cX0e4UXnYsbNTo8b6FUwq/WZ1URc7ixr6WlV8=",
  },
  "(Drop files or click)": {
    val: "(Upuść pliki lub kliknij)",
    translated: true,
    h: "cn8vjUpkolK+X1qsHPyR11Qj7uQWZVR6eWnhPRb/zfw=",
  },
  "(If you want a response)": {
    val: "(Jeśli chcesz otrzymać odpowiedź)",
    translated: true,
  ...
  "Actual Size": {
    val: "Rzeczywisty rozmiar",
    translated: true,
    h: "k1ZfUj7bmT4XwiALRlZo7ztl2d+e7JcLt3WCnvjpBYg=",
  },
  "Advanced settings": {
    val: "Ustawienia zaawansowane",
    translated: true,
  ...
  "Amount of money over-allocated in buckets.": {
    val: "Kwota nad-alokowana w kubełkach.",
    translated: true,
  ...
  "Attached files are too large.": {
    val: "Załączone pliki są zbyt duże.",
    translated: true,
  ...
  "Break Import Links": {
    val: "Podziel linki do importu",
    translated: true,
    h: "XQYKw3qJ7xKoR/DX6K6NdZxbJLHVJhxy9mFVV8r1ZU4=",
  },
  "Bring All to Front": {
    val: "Przenieś wszystko na wierzch",
    translated: true,
  ...
  "Checking for updates...": {
    val: "Sprawdzam dostępność aktualizacji...",
    translated: true,
  ...
  "Create Backup": {
    val: "Utwórz kopię zapasową",
    translated: true,
    h: "tUZEq5sa8Ggh6lIgsWzX8Blj6/unJ8dhl9sKpfwxRYY=",
  },
  "Create Backup and Start Over": {
    val: "Utwórz kopię zapasową i rozpocznij od początku",
    translated: true,
  ...
  "Error running recording": {
    val: "Błąd przy nagrywaniu",
    translated: true,
    h: "eE9Fw8G4vQpND3fFWnfGNvtN5LxCcQQecWO6fQgBmpM=",
  },
  "Error running sync": {
    val: "Błąd przy synchronizacji",
    translated: true,
  ...
  "If Net is 0, the bucket transactions will be marked as transfers rather than as income or expenses.": {
    val: "Jeśli Bilans równa się 0, transakcje pomiędzy kubełkami będą oznaczone jako przelewy, a nie wydatki lub przychody.",
    translated: true,
  ...
  "Import links broken": {
    ...
    val: "Uszkodzone linku do importowania",
    translated: true,
  ...
  "Install and Relaunch Buckets": {
    val: "Zainstaluj i uruchom ponownie program Buckets",
    translated: true,
  ...
  "Invalid categorization.  Categories not set.": {
    val: "Nieprawidłowa kategoryzacja. Nie utworzono Kategorii.",
    translated: true,
    h: "DykWhCxgeqeIt2i+Lc2sRdURMNIgRgohpjs83umwH9Y=",
  },
  "Invalid date": {
    val: "Nieprawidłowa data",
    translated: true,
    h: "wDN2ZzrVLU22Lij4eJJvxPBmC6Qv9SPmgRT36Qpq9KE=",
  },
  "Invalid license": {
    val: "Brak ważnej licencji",
    translated: true,
  ...
  "Keep account transactions": {
    val: "Zachowaj transakcje w ramach konta",
    translated: true,
  ...
  "Keep bucket transactions": {
    val: "Zachowaj transakcje w ramach kubełka",
    translated: true,
    h: "0LwH6beBDlpdXvsVWW7nGj/5/tkz7gDk+Sm4Kltx3rQ=",
  },
  "Keep buckets": {
    val: "Zachowaj kubełki",
    translated: true,
  ...
  "Negate": {
    ...
    /* Verb meaning to make a number have the opposite sign */
    val: "Zmień wartość na ujemną lub dodatnią",
    translated: true,
  ...
  "No matches found": {
    val: "Nie znaleziono szukanej frazy",
    translated: true,
  ...
  "No orders imported": {
    val: "Nie zaimportowano zamówień",
    translated: true,
    h: "BSXGKYKVKCk7fbaNo3wAigIjqpZPNfJFNISloGmngZg=",
  },
  "No refunds imported": {
    val: "Nie zaimportowano zwrotów",
    translated: true,
  ...
  "Open Recent...": {
    val: "Otwórz ostatnio używany...",
    translated: true,
    h: "Uf1w3VIwUvsmKvOkQtBwsGvbRzQ5gMbEq/iyNzv95cs=",
  },
  "Open Transaction File": {
    val: "Otwórz plik z transakcjami",
    translated: true,
  ...
  "Please enter your Buckets License below.": {
    val: "Wprowadź poniżej swoją licencję Buckets.",
    translated: true,
  ...
  "Record change as transaction": {
    val: "Zapisz zmianę jako transakcję",
    translated: true,
  ...
  "Remove Categorization": {
    val: "Usuń kategoryzację",
    translated: true,
    h: "b5sIQMfXAnBAqHD2NJfIgIAxclRGe5LJ7NzzF6sOruQ=",
  },
  "Rent/Mortgage": {
    val: "Czynsz/Kredyt Hipoteczny",
    translated: true,
  ...
  "Search for Amazon transactions:": {
    val: "Wyszukaj transakcje na Amazon:",
    translated: true,
  ...
  "Show full changelog": {
    val: "Pokaż pełną listę zmian",
    translated: true,
    h: "nu/b3QeVa2N7QmrPffBdK2zSVYIp81gVGbFjcYrlL5A=",
  },
  "Show uncategorized": {
    val: "Pokaż transakcje bez kategorii",
    translated: true,
  ...
  "Start with a template": {
    val: "Rozpocznij korzystając z szablonu",
    translated: true,
  ...
  "Student Loan Payment": {
    val: "Płatność za kredyt studencki",
    translated: true,
  ...
  "This tool will delete data to make it easy to start over with your budget.": {
    val: "To narzędzie skasuje dane i pozwoli na łatwe rozpoczęcie tworzenia budżetu od nowa.",
    translated: true,
    h: "+40oxGj2jDLNe4ggunYHsgL/9aQz0pw5IeRM5VlYIIU=",
  },
  "Thousands separator": {
    val: "Separator tysięcy",
    translated: true,
  ...
  "To use Buckets, you must accept the End User License Agreement (EULA).": {
    val: "Aby korzystać z Buckets, musisz zaakceptować Umowę licencyjną użytkownika końcowego (EULA).",
    translated: true,
    h: "0six0i9oNNM/hjCYct1UTEqdgMn0uoBbaBq0cvnoZLM=",
  },
  "Toggle Developer Tools": {
    val: "Włącz/Wyłącz narzędzia deweloperskie",
    translated: true,
    h: "IYSSUL9ezB58nRuajYVa+zH4ucrmXQOB92zA7sDlrJc=",
  },
  "Toggle Full Screen": {
    val: "Włącz/Wyłącz pełny ekran",
    translated: true,
  ...
  "Unexpected sync error": {
    val: "Niespodziewany błąd podczas synchronizacji",
    translated: true,
  ...
  "Update Target Date": {
    val: "Zmień datę docelową",
    translated: true,
    h: "SEac1rQopyHALPSWU85qYV3GE0x9i2OGDB+JYnVID8A=",
  },
  "Update Transaction": {
    val: "Zapisz zmiany w transakcji",
    translated: true,
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    val: "Uwaga: To działanie spowoduje, że wolne środki, w tym miesiącu, nie wystarczą na wypełnienie kubełków i dodatkowe środki mogą zostać pobrane z przyszłych miesięcy (jeśli są dostępne).",
    translated: true,
  ...
  "You must backup to a different file.": {
    val: "Musisz zrobić kopię zapasową do innego pliku.",
    translated: true,
    h: "LAt5pxdaPsRHDU6bS2Cu1aEDIQ2oZAMw46Pa7H6pc5o=",
  },
  "Your email address:": {
    val: "Twój adres email:",
    translated: true,
  ...
  "bucket.transfer.help": {
    val: "Przelew to transakcja przełożenia pieniędzy z kubełka do innego kubełka.  Jeśli transakcja nie jest przychodem lub wydatkiem, najpewniej jest przelewem.",
    translated: true,
  ...
  "error-detail": {
    val: "Jeśli ten błąd powtarza się lub nie ma sensu, zgłoś proszę błąd lub pogadaj z nami.",
    translated: true,
  ...
  "getting-started-link": {
    val: (clickhandler) => {
          return <span>Używasz Buckets po raz pierwszy? Obejrzyj <a href="#" onClick={clickhandler}>Filmy Na Start.</a></span>
        },
    translated: true,
  ...
  "money-balance-as-of": {
    val: (amount:JSX.Element, date:JSX.Element) => {
                  return <span>{amount} na dzień {date}</span>
                },
    translated: true,
  ...
  "months gain/loss label": {
    val: (gain) => {
                        return gain >= 0 ? "Miesięczny zysk" : "Miesięczna strata";
                      },
    translated: true,
  ...
  "nag-message": {
    val: () => `Ta wersja jest niezarejestrowna i mimo, że ma nieograniczoną funkcjonalność, licencja musi zostać zakupiona aby można było używać programu.

Czy chciałbyś kupić licencję teraz?`,
    translated: true,
  ...
  "net-transfers.help": {
    val: "Przelewy netto to suma wszystkich transakcji oznaczonych jako przelew. Wartośc powinna wynosić 0.  Jeśli tak nie jest przejrzyj transakcje pod kątem powtórzeń lub błędnie przypisanych kategorii.",
    translated: true,
  ...
  "notify-downloaded-file": {
    val: filename => `Pobrano plik: ${filename}`,
    translated: true,
  ...
  "press Escape to close": {
    val: "naciśnij Escape aby zamknąć",
    translated: true,
  ...
  "rain.help.neg": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Masz o {abs_amount} za dużo w kubełkach.  Jeśli wszystkie transakcje zostały pokategoryzowane, wyjmij {abs_amount} z wybranych kubełków.
                                      </span>
                                    },
    translated: true,
  ...
  "rain.help.pos": {
    val: (abs_amount:JSX.Element) => {
                                      return <span>
                                      Zostało {abs_amount} do dodania do kubełków.
                                      </span>
                                    },
    translated: true,
  ...
  "shipment-number": {
    ...
    val: (number:number)=>`Numer przesyłki ${number}`,
    translated: true,
    h: "kOj0AkivxHYJj3IKqIFziGCcIwk1yxyUrloX+kGlOd0=",
  },
  "simplefin-connect-intro": {
    val: "Aby połączyć, wykonaj następujące czynności:",
    translated: true,
    h: "421gz/BziKZhsIy2YKRFNtwoqPcbQ7uhFZWWfd6ReBg=",
  },
  "simplefin-get-token": {
    val: (mklink) => {
              return <span>Pobierz SimpleFIN Token z {mklink('SimpleFIN Bridge')}</span>
            },
    translated: true,
    h: "VEeKjngcHxowWbB2xWy5oNH4MXIfJQ7EqpiomT6V0fg=",
  },
  "simplefin-paste": {
    val: "Następnie wklej tu SimpleFIN Token:",
    translated: true,
  ...
  "sync-symbol help": {
    val: "Ten symbol oznacza, że transakcja została dodana przez importowanie lub synchronizację",
    translated: true,
    h: "S3tDRls+AJYj6f8jSNSCa1FVyNY+ngn6Db1EQJ3dpLE=",
  },
  "sync.toast.syncing": {
    val: (start: string, end: string) => {
        return `Synchronizuję transakcje od ${start} do ${end}`;
      },
    translated: true,
  ...
  "transfer-from-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Przelej z {dropdown}</span>
              },
    translated: true,
  ...
  "transfer-to-account": {
    val: (dropdown:JSX.Element) => {
                return <span>Przelej do {dropdown}</span>
              },
    translated: true,
